new Vue({
  ...
  methods: {
    addStudent: function() {
      ...
      // pushでstudentsの配列に入れている、何を入れるのかはthisで参照して加えてる。
      this.students.push ({ id: this.defaultLastId = this.defaultLastId +1, name: this.name, course: this.course, acceptancePeriod: this.acceptancePeriod })
    }
  }
})
